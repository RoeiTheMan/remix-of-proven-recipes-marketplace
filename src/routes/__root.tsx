...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Pickture — Verified visual recipes for AI image generation" },
      { property: "og:description", content: "Buy and sell tested, reproducible AI image-generation recipes. Proven visuals, verified every time." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Pickture — Verified visual recipes for AI image generation" },
      { name: "twitter:description", content: "Buy and sell tested, reproducible AI image-generation recipes. Proven visuals, verified every time." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8715ae2c-8a65-4015-a7d6-bcdb1a0710c4/id-preview-c72be870--e51a12ab-3c5b-4074-86a3-b1a00b1c99d2.lovable.app-1785749604677.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/8715ae2c-8a65-4015-a7d6-bcdb1a0710c4/id-preview-c72be870--e51a12ab-3c5b-4074-86a3-b1a00b1c99d2.lovable.app-1785749604677.png" },
    ],
    links: [
